...
生成式 AI 融入大學地科與 STEM 教學之實證研究：基於學生數位專題作品的縱向分析

**An Empirical Study of Integrating Generative AI into University Earth Science and STEM Education: A Longitudinal Analysis Based on Students' Digital Project Portfolios**
...
## 中文摘要（約 380 字，符合 500 字內規定）

隨著生成式AI普及，跨領域STEM素養成為科學教育的重要指標。本研究以台北市立大學「地球物理」與「地震學」兩門連續課程為場域，探討將生成式AI（ChatGPT、Gemini）融入大學地科與STEM教學之實證成效。本研究追蹤學生跨學期應用AI輔助建置「數位專題作品」的縱向發展，建立「媒體豐富度」與「排版架構」雙軸尺規，並透過文本分析計算可見字數及批判思考比例，以客觀量化學習軌跡。8位高信度配對學生納入班級縱向統計，結果顯示：學生期末專題的媒體豐富度由1.75分顯著升至3.50分；字數由1,983字大幅增至3,693字（+86.2%）；批判思考訊號比例亦由6.54%升至10.73%。此外，以「先備專題經驗」分組的結果顯示，新加入學生在媒體豐富度與反思深度的增幅大於先備組，呈現期末差距收斂。本實證研究確認，生成式AI不僅有效推動STEM知識展演，更為低先備經驗學生提供了潛在的追趕路徑。
...
1. 針對生成式AI融入大學地科與STEM教學，建立客觀量化之「數位專題作品複雜度尺規」與「文本分析指標」，提供跨領域教學之實證評量工具。
2. 探討連續兩學期（縱向）AI 協作與雲端實作訓練下，學生數位專題作品在媒體豐富度、知識表達及批判思考深度的發展軌跡。
3. 分析本教學模式對不同先備經驗學生之早期表現差距與後續追趕效應。

### 二、研究重要性

傳統地科教學常以紙本測驗評量，難以反映學生的跨領域 STEM 實作與知識整合能力。本研究跳脫傳統框架，針對「生成式 AI 輔助專題導向學習 (PBL)」提出具體的實證研究架構。透過量化學生歷時性「數位專題作品」的表達品質與反思深度，精準捕捉 AI 作為學習鷹架的實質成效，為高等教育推動 AI 融入 STEM 跨領域課程提供了具體的評量工具與實踐範例。

### 三、研究方法

本實證研究採量化之數位成品分析法（Digital Artifact Analysis），追蹤學生上、下學期數位專題作品之原始碼與可見文字，純粹聚焦其「呈現品質」與「文本豐富度」之縱向發展。

**1. 專題複雜度尺規（1–4 分）**：以 HTML 結構自動判定「媒體豐富度」（純文字 1 分 → 圖文 2 分 → 互動／多媒體元素 3 分 → 進階視覺工具或多重整合 4 分）與「排版架構」（無結構 1 分 → 基本段落 2 分 → 導覽列與多區塊 3 分 → API 動態資料串接 4 分）。
...
**3. 學生迴響與成效**
將學習成果轉化為具體的網頁作品，為學生帶來了極高的成就感與參與動機。如同前述量化分析所示，學生不僅在認知與技術操作上成功跨越門檻，其產出的「媒體豐富度」與「可見字數」均有顯著的爆發性成長。更重要的是，在 AI 工具的輔助下，學生有更多心力投入在實驗檢討與知識重組上，促使期末作品中的批判思考與反思訊號比例大幅提升，印證了此教學模式在知識內化與素養深化上的實質效益。

### 六、關鍵圖表

本研究擷取兩張最具代表性之分析圖表，說明學生在跨學期歷程中的文本成長與先備經驗追趕效應：

- **圖一：文本分析指標跨學期位移散佈圖**（對應 `figure2_text_analytics_trajectory`）
  本圖追蹤 8 位高信度配對學生在上、下學期間的文本發展。各資料點之位移箭頭顯示，多數學生在可見字數與批判思考比例上皆有明顯增長，反映出學生在期末能產出更具論述深度與反思性的數位內容。
- **圖二：先備組與新加入組之期末差距收斂軌跡**（對應 `figure5_hw2_to_final_group_trajectories`）
  本圖比較了具備上學期課程經驗之「先備組」與下學期「新加入組」的學習軌跡。結果顯示，新加入組在課程後期的媒體豐富度與批判思考訊號上呈現更大的增幅，成功縮小了早期的落差，顯示 AI 輔助的教學模式對低先備經驗學生具有潛在的追趕效益。
